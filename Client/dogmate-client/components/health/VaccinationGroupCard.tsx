...
export default function VaccinationGroupCard({
  group,
  expanded,
  onToggleHistory,
  onEdit,
    ...
    <View style={styles.card}>
      <View style={styles.cardTopRow}>
        <View style={styles.cardBody}>
          ...
          <Text style={styles.vaccine}>{group.vaccineName}</Text>
      ...
      <View style={styles.historySection}>
        <View style={styles.historyHeaderRow}>
          ...
          <Text style={styles.historyTitle}>היסטוריית חיסונים ({group.history.length})</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  vaccine: { fontSize: 15, color: TEXT_DARK, marginTop: 4, textAlign: 'right', writingDirection: 'rtl' },
